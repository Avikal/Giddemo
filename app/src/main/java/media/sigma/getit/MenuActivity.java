...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent offers = new Intent(MenuActivity.this,MainActivity.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager(),MenuActivity.this, valueclick);

        adapter.addFragment(new RentClass(MenuActivity.this,valueclick), "New Arrival");
        adapter.addFragment(new BuyClass(MenuActivity.this,valueclick), "Populer");
